...
import { calendarEventUpdatedConfigSchema } from '@tietide/shared';
...
export function CalendarEventUpdatedForm({ nodeId, config }: NodeConfigFormProps): JSX.Element {
  ...
  const parsed = calendarEventUpdatedConfigSchema.safeParse({
  ...
  return (
    <div data-testid="calendar-event-updated-form" className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        ...
        {issueFor('connectionId') && (
          <p
            data-testid="calendar-event-updated-connection-error"
            role="alert"
