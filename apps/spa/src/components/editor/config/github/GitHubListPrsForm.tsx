import { githubListPrsConfigSchema, GITHUB_ISSUE_STATES } from '@tietide/shared';
...
export function GitHubListPrsForm(props: NodeConfigFormProps): JSX.Element {
  return (
    <GenericConnectorForm
      {...props}
      testId="github-list-prs-form"
      provider="github"
      providerLabel="GitHub"
      schema={githubListPrsConfigSchema}
      fields={FIELDS}
